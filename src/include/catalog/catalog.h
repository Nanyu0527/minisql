...
public:
  ...
  void InitCatalogMetaPage(char* buf);
  // BufferPoolManager *Getbuffer_pool_mamager(){return buffer_pool_manager_;}

  dberr_t CreateTable(const std::string &table_name, TableSchema *schema, Transaction *txn, TableInfo *&table_info,vector<uint32_t>primary_key);
